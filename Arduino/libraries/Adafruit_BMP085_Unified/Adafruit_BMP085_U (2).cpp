...
{
  Serial.print(_bmp085_coeffs.ac1);
  Serial.print(_bmp085_coeffs.ac2);
  Serial.print(_bmp085_coeffs.ac3);
}
...
static void read8(byte reg, uint8_t *value)
{
  ...
  Wire.requestFrom((uint8_t)BMP085_ADDRESS, (byte)1);
    ...
    *value = Wire.receive();
      #ifdef DEBUG
        Serial.println("value from read8:");
        Serial.print(*value);
        Serial.println("");
    #endif
  #endif  
...
bool Adafruit_BMP085_Unified::begin(bmp085_mode_t mode)
{
  ...
  Wire.begin();
  #ifdef DEBUG
    Serial.println("BMP180 I2C address: "); Serial.print((uint8_t)BMP085_ADDRESS); Serial.println("");
  #endif
